...
#ifdef CONFIG_CXD22XX_NFC_SERVICE_MODE
    case CXDNFC_SERVICEMODE_CTL:
        gpio_set_value(cxd22xx_dev->gpio->tst1_gpio, 1);
        msleep(10);
        gpio_set_value(cxd22xx_dev->gpio->wake_gpio, 1);
        gpio_set_value(cxd22xx_dev->gpio->rst_gpio, 1);
        msleep(1);
        gpio_set_value(cxd22xx_dev->gpio->rst_gpio, 0);
        msleep(10);
        gpio_set_value(cxd22xx_dev->gpio->tst1_gpio, 0);
        msleep(4000);
        break;
#endif
#endif
